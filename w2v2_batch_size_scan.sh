...
#find "$DIR" -name "*000000050000*" -exec sbatch --array=0,4,7,10-15,18-21 slurm_snellius.sbatch "$JOBNAME"-050k-"$LR" wav2vec2_custom {} "$LR" \;
#find "$DIR" -name "*000000150000*" -exec sbatch --array=0,4,7,10-15,18-21 slurm_snellius.sbatch "$JOBNAME"-150k-"$LR" wav2vec2_custom {} "$LR" \;
#find "$DIR" -name "*000000250000*" -exec sbatch --array=0,4,7,10-15,18-21 slurm_snellius.sbatch "$JOBNAME"-250k-"$LR" wav2vec2_custom {} "$LR" \;
#find "$DIR" -name "*000000350000*" -exec sbatch --array=0,4,7,10-15,18-21 slurm_snellius.sbatch "$JOBNAME"-350k-"$LR" wav2vec2_custom {} "$LR" \;
